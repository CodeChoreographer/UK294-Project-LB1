...
export const appRoutes: Routes = [
  {path: '', redirectTo: '/products', pathMatch: 'full'},
  {
    ...
    children: [
      ...
      {
        path: 'promote',
        loadComponent: () => import('./users/user-promote/user-promote.component').then(m => m.UserPromoteComponent),
        canActivate: [AdminGuard]
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: ':id',
        loadComponent: () => import('./categories/category-detail/category-detail.component').then(m => m.CategoryDetailComponent)
      },
      {
        path: 'edit/:id',
